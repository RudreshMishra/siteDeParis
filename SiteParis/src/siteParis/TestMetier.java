...
public class TestMetier {
	...
	public static void testInscrireDesinscrireJoueur () {
		...
		try {
			...
			String passwdSabcn = siteDeParisMetier.inscrireJoueur(new String("Xyzbc"), new String("Abcder"), new String("tfgdghh"), new String("ilesCaimans"));
			...
			try {//new String("Prou")
				siteDeParisMetier.inscrireJoueur(new String("Morgan"), new String("Morgan"), "titi", new String("ilesCaimans"));
	...
	public static void testCrediterDebiterJoueur () {
		...
		try {
			...
			try {
				siteDeParisMetier.crediterJoueur(null, new String("Bernard"), new String("nanard"), 1789, new String("ilesCaimans"));
				System.out.println("you cannot credit player without the his name");
			}
			catch (JoueurException e) { }
			catch (Exception e) { 
				System.out.println("you cannot credit player without the his name throw exception joueurException mais " + e.getClass().getName());
			}
			
			try {
				siteDeParisMetier.crediterJoueur(new String("Prou"), null, new String("nanard"), 1789, new String("ilesCaimans"));
				System.out.println("you cannot credit player without the his prename");
			}
			catch (JoueurException e) { }
			catch (Exception e) { 
				System.out.println("you cannot credit player without the his prename throw exception joueurException mais " + e.getClass().getName());
			}
			
			try {
				siteDeParisMetier.crediterJoueur(new String("Prou"), new String("Bernard"), new String("nanard"), 1789,null);
				System.out.println("crediter a joueur  avec un password gestionnaire invalide (non instancié)  n'a pas levé l'exception MetierException ");
			}
			catch (MetierException e) { }
			catch (Exception e) { 
				System.out.println("crediter a joueur  avec un password gestionnaire invalide (non instancié) n'a pas levé l'exception MetierException mais " + e.getClass().getName());
			}
			
			try {
				siteDeParisMetier.crediterJoueur(new String("Mishr"), new String("Rudre"), new String("nanard"), 1789,new String("ilesCaimans"));
				System.out.println("credite the joueur who has not inscrire in the game");
			}
			catch (JoueurInexistantException e) { }
			catch (Exception e) { 
				System.out.println("credite the joueur who has not inscrire in the game n'a pas levé l'exception JoueurInexistantException mais " + e.getClass().getName());
			}
			...
			try {
				siteDeParisMetier.crediterJoueur(new String("Prou"), new String("Bernard"), new String("nanard"),0, new String("ilesCaimans"));
				System.out.println("you can not credit the zero amount to the players account");
			}
			catch (JoueurException e) { }
			
			try {
				siteDeParisMetier.debiterJoueur(null, new String("Bernard"), new String("nanard"), 1789, new String("ilesCaimans"));
				System.out.println("you cannot debit amount from the  player without the his nom ");
			}
			catch (JoueurException e) { }
			catch (Exception e) { 
				System.out.println("you cannot debit amount from the  player without the his nom exception joueurException mais " + e.getClass().getName());
			}
			
			try {
				siteDeParisMetier.debiterJoueur(new String("Prou"), null, new String("nanard"), 1789, new String("ilesCaimans"));
				System.out.println("you cannot debit amount from the  player without the his prenom");
			}
			catch (JoueurException e) { }
			catch (Exception e) { 
				System.out.println("you cannot debit amount from the   player without the his prenom thow  exception joueurException mais " + e.getClass().getName());
			}
			
			try {
				siteDeParisMetier.debiterJoueur(new String("Prou"), new String("Bernard"), new String("nanard"), 1789,null);
				System.out.println("debiter a joueur  avec un password gestionnaire invalide (non instancié)  n'a pas levé l'exception MetierException ");
			}
			catch (MetierException e) { }
			catch (Exception e) { 
				System.out.println("debiter a joueur  avec un password gestionnaire invalide (non instancié) n'a pas levé l'exception MetierException mais " + e.getClass().getName());
			}
			
			
			try {
				siteDeParisMetier.debiterJoueur(new String("Mishr"), new String("Rudre"), new String("nanard"), 1789,new String("ilesCaimans"));
				System.out.println("debiter the joueur who has not inscrire in the game");
			}
			catch (JoueurInexistantException e) { }
			catch (Exception e) { 
				System.out.println("debiter the joueur who has not inscrire in the game n'a pas levé l'exception JoueurInexistantException mais " + e.getClass().getName());
			}
	...
	public static void testMiserVainqueur () {
		...
		try {
			...
			try {
				siteDeParisMetier.miserVainqueur(new String("nanard"), new String("iampassword"), 40, new String("ChampionnatDeFrance2012"), new String("Lyon"));
				System.out.println("place the bet with the wrong user password  n'a pas levé l'exception JoueurException ");
			}
			catch (JoueurException e) { }
			catch (Exception e) { 
				System.out.println("place the bet with the wrong user password n'a pas levé l'exception JoueurException mais " + e.getClass().getName());
			}
			
			try {
				siteDeParisMetier.miserVainqueur(new String("lolol"), new String("iampassword"), 40, new String("ChampionnatDeFrance2012"), new String("Lyon"));
				System.out.println("place the bet with the wrong user password  n'a pas levé l'exception JoueurInexistantException ");
			}
			catch (JoueurInexistantException e) { }
			catch (MetierException e) { }
			catch (Exception e) { 
				System.out.println("place the bet with the wrong user password n'a pas levé l'exception MetierException mais " + e.getClass().getName());
			}
			
			try {
				siteDeParisMetier.miserVainqueur(new String("nanard"), new String(passwdBernard), 40, new String("ChampionnatMoFrance2012"), new String("Lyon"));
				System.out.println("placing the bet on the competition which does not exist  n'a pas levé l'exception CompetitionInexistanteException ");
			}
			catch (CompetitionInexistanteException e) { }
			catch (Exception e) { 
				System.out.println("placing the bet on the competition which does not exist n'a pas levé l'exception CompetitionInexistanteException mais " + e.getClass().getName());
			}
			
			try {
				siteDeParisMetier.miserVainqueur(new String("nanard"), new String(passwdBernard), 40, new String("ChampionnatDeFrance2012"), new String("Nice"));
				System.out.println("placing the bet on competiteur which does not exist in competition  n'a pas levé l'exception CompetitionException ");
			}
			catch (CompetitionException e) { }
			catch (Exception e) { 
				System.out.println("placing the bet on competiteur which does not exist in competition n'a pas levé l'exception CompetitionException mais " + e.getClass().getName());
			}
			
			try {
				siteDeParisMetier.miserVainqueur(null, new String(passwdBernard), 40, new String("ChampionnatDeFrance2012"), new String("Brest"));
				System.out.println("pseudo can not be null  n'a pas levé l'exception JoueurException ");
			}
			catch (JoueurException e) { }
			catch (Exception e) { 
				System.out.println("pseudo can not be null n'a pas levé l'exception JoueurException mais " + e.getClass().getName());
			}
